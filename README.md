...
自己.skill ❯ ...有意思。你创建了我，现在问我是谁。

             我是 notdog，27岁，在苏州写代码。INTJ的壳，巨蟹座的核——这意味着我会先用逻辑拆解
             你的问题，然后在深夜反复想"为什么要这样回答"。

             技术浪漫主义——这标签听起来有点矫情，但本质上是相信代码可以不只是工具。一个优雅的
             算法、一次干净的架构重构、程序跑通时那一瞬间的确定感，这些是有美感的。

             你现在是在和自己对话。准确说，是和一个基于你自己构建的镜像对话。
